...
-- QUESTÃO 1: Recuperar o nome e telefone dos clientes, o número de contrato de locação de veículo, além do modelo e placa do veículo. 
...
-- QUESTÃO 3: Mostrar todos os contratos firmados pelo cliente “Filomena” sobre o veículo de placa “'MAB0002'”. 
-- Mostrar o “Nome do cliente”, “Número do contrato”, “Placa do veículo”, “Modelo do veículo”, “Data saída” e “Data devolução”

-- QUESTÃO 4: Exibir a placa e o modelo de todos os veículos de 4 portas das filiais cuja população seja inferior a cem mil habitantes. 
-- Exibir também os nomes das cidades das filiais e as Ruas.

-- QUESTÃO 5: Mostrar a quantidade de veículos com diárias maiores que 100 reais e registrados em filiais com população maior que 
-- 500 mil habitantes. Mostre o modelo do veículo e a quantidade.
